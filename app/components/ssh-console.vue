  ...
  <Card class="h-[600px] flex flex-col">
    <CardContent class="p-0 flex-1 flex flex-col">
      ...
      <div class="p-2 border-t bg-card flex items-center gap-2">
        <span class="font-mono text-sm text-muted-foreground pl-2">/data #</span>
        <Input 
          v-model="commandInput" 
          @keyup.enter="sendCommand" 
          placeholder="ls -l, cat server.properties, etc..." 
          class="bg-transparent border-none focus-visible:ring-0 focus-visible:ring-offset-0 shadow-none font-mono" 
        />
